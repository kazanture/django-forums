...
class PostUpdateViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.topic = Topic.objects.create(subject='Hello, world', forum=self.forum, author=user)
        self.post = Post.objects.create(message='Lorem ipsum dolor sit amet', topic=self.topic, author=user)
